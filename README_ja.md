...
<a name="最新动态"></a>
# 最新情報 🔥
- 2026/07: **FunASR 1.3.28 で SenseVoice の字幕同期を改善** — リアルタイムセッションは、VAD 確定後の最終デコードが悪化した場合に安定したテキストを保持し、`STOP` 受信時に短い末尾音声をデコードするため、最終字幕の欠落やずれを抑えます。`pip install -U "funasr==1.3.28"` でインストールできます。[リリースノート](https://github.com/modelscope/FunASR/releases/tag/v1.3.28) · [字幕ガイド](https://www.funasr.com/en/blog/funasr-v1-3-28-realtime-websocket-subtitles.html) · [PyPI](https://pypi.org/project/funasr/1.3.28/)
