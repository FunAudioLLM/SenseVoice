...
SenseVoiceSmall examples and the composed FunASR diarization path require `funasr>=1.3.25`. If you installed this repository earlier, run `pip install -U "funasr>=1.3.25"` before retrying the demos.
